...
1:    @ wait for busy bit to be cleared
	...
	ldr r6,=acomu_wait_time	@kiseki_kaiで記述されている一音の長さのデータです。
...
@========================================================================
	@タスクの選択
	cmp	r5,r6	@現在時刻と比べてacomu_kaiの呼び出しのタイミングが来ていなければ呼び出さない
...
@=================================呼び出しした場合のみ動作=======================================
	...
	ldr	r1, =acomu_wait_time
	add r6,r6,r1		@呼び出しタイミングの更新（一音の長さをそれぞれの音に対して配列として格納している場合は読んでこなければいけない）
